...
VkPipeline CreatePipeline(VkPipelineLayout pipelineLayout,
  ...
  VkShaderModule vertShaderModule = createShaderModule(
      "1_helloTriangle/shaders/shader.vert.spv", device->GetVulkanDevice());
  VkShaderModule fragShaderModule = createShaderModule(
      "1_helloTriangle/shaders/shader.frag.spv", device->GetVulkanDevice());
...
int main(int argc, char** argv) {
  ...
  instance->PickPhysicalDevice(
      ...
      QueueFlagBit::GraphicsBit | QueueFlagBit::PresentBit, surface);
