...
VkInstance VulkanInstance::GetVkInstance() { return instance; }

VkPhysicalDevice VulkanInstance::GetPhysicalDevice() { return physicalDevice; }
...
const std::vector<VkSurfaceFormatKHR>& VulkanInstance::GetSurfaceFormats()
    const {
...
uint32_t VulkanInstance::GetMemoryTypeIndex(
...
void VulkanInstance::PickPhysicalDevice(
    std::vector<const char*> deviceExtensions, QueueFlagBits requiredQueues,
...
VulkanDevice* VulkanInstance::CreateDevice(
    QueueFlagBits requiredQueues, VkPhysicalDeviceFeatures deviceFeatures) {
